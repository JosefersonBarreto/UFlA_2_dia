---
title: "Dashboard UFLA Apresentação"
format: 
  dashboard:
    nav-buttons: [github]
   # github: https://github.com/mine-cetinkaya-rundel/ld-dashboard
logo: images/logo-ufla.png
...
ld %>%
  ...
  geom_line(linewidth = 2, color = "#966111") +
  geom_point(size = 3, color = "orange") +
  geom_point(size = 6, color = "orange", shape = "circle open") +
  labs(x = NULL) +
  scale_y_continuous(
    "Count",
    sec.axis = sec_axis(~ . / n_births, name = "Proportion", labels = scales::label_percent())
  ) +
  theme(
    #panel.background = element_rect(fill = "#0e4935"),
    plot.background = element_rect(fill = "#172155"),
